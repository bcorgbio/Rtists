...
```{r, "species PV", fig.height=4, fig.width=4, cache=TRUE,fig.cap="Philadelphia Virelo"}
pv<- dat%>%
...
ep.arrive.date%>%
  ggplot(aes(year,j.day))+geom_point()
```
```{r fig.height=4, fig.width=4, cache=TRUE, "day of the year .25 of the population arrives, varyin 2", fig.cap="Philadelphia Virelo"}
#Vireo philadelphicus - Philadelphia Virelo 
